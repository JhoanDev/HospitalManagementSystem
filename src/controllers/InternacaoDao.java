...
public class InternacaoDao {
    ...
    public static void cadastrarInternacao(Internacao internacao, Banco db) {
        String query = String.format(
                "INSERT INTO Internacao (data_internacao, data_alta, id_paciente, id_enfermaria) VALUES ('%tF', '%tf', '%s','%s');",
                internacao.getDataInternacao(), internacao.getDataAlta(),Integer.parseInt(internacao.getIdPaciente()),
